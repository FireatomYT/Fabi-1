 ...
 *      code</a>
 * @see <a href=
 *      "https://commons.apache.org/proper/commons-codec/jacoco/org.apache.commons.codec.digest/MurmurHash3.java">
 *      Apache MurmurHash3.java</a>
 */
...
public final class MurmurHash3 {
	...
	public static class IncrementalHash32x86 {
		...
		public final void add(final byte[] data, final int offset, final int length) {
			...
			// Check if the unprocessed bytes and new bytes can fill a block with 4.
			...
			if (unprocessedLength > 0) {
				int k = switch (unprocessedLength) {
					case 1 -> orBytes(unprocessed[0], data[offset], data[offset + 1], data[offset + 2]);
					case 2 -> orBytes(unprocessed[0], unprocessed[1], data[offset], data[offset + 1]);
					case 3 -> orBytes(unprocessed[0], unprocessed[1], unprocessed[2], data[offset]);
					default ->
